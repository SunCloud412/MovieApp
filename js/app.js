const API_KEY = "861128d6-1c40-40d4-91fb-8bcd93c30725";
...
function showMovies(data) {
    ...
    data.films.forEach(movie => {
        ...
        `<div class="movie-cover-inner">
            <img src="${movie.posterUrlPreview}" class="movie-cover" alt="${movie.nameRu}">
    ...
    modalEl.innerHTML = `
        <div class="modal-card">
            ...
            <ul class="modal-movie-info">
                ...
                ${respData.filmLength ? `<li class="modal-movie-runtime">Время: ${respData.filmLength} минут</li>` : ''}
